export function shiftReduceCollision(grammar, state, shift, reduce, error) {
    const sym = shift.item.renderSymbol(grammar);
    error.log(`\x1b[43m SHIFT/REDUCE \x1b[43m COLLISION ERROR ENCOUNTERED:\x1b[0m
...
export function reduceCollision(grammar, state, reduce_existing, reduce_new, error) {
