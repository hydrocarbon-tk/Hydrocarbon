...
export default function (sym, env) {
    const FILE_URL = env.FILE_URL, AWAIT = env.AWAIT, PENDING_FILES = env.PENDING_FILES, meta_imported_productions = env.meta_imported_productions, url = sym[3], id = sym[6];
    const 
