 ...
 * disclaimer notice.
 */
import { ProductionSymbol } from 'build/types/types/grammar_nodes.js';
...
import {
    GrammarObject, GrammarProduction, TokenSymbol,
...
import { InScopeItemState, skipped_scan_prod } from '../../utilities/magic_numbers.js';
...
function processTransitionNode(
    ...
    const { hash, action } = generateStateHashAction(state, grammar, options);

    state_string.push(action);
