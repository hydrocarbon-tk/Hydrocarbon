...
import { goto_state_mask, fail_state_mask, normal_state_mask } from "../utilities/magic_numbers.js";
import { GrammarObject, ReverseStateLookupMap } from '../types/index.js';
import { renderHTMLStateFromBytecode } from './assembly.js';
import { getEntryPointers } from '../render/entry_pointers.js';
...
export function renderByteCodeSheet(
    ...
    const entry = grammar ? getEntryPointers(grammar, states_lookup) : [];
