...
,(env, sym, pos)=>( sym[1].map(e=>(e.NO_BLANK=true,e)))/*35*/
,(env, sym, pos)=>( true)/*36*/
...
,(env, sym)=>new (class{constructor(env, sym, pos){this.type="symbol";this.val=sym[0];this.pos=pos;}})(env, sym)/*53*/
...
,(env, sym)=>new (class{constructor(env, sym, pos){this.type="eof";this.val="$eof";this.pos=pos;}})(env, sym)/*57*/
,(env, sym)=>new (class{constructor(env, sym, pos){this.type="empty";this.pos=pos;}})(env, sym)/*58*/
...
,(env, sym)=>new (class{constructor(env, sym, pos){this.type="generated";this.val=sym[1];this.pos=pos;}})(env, sym)/*61*/
,(env, sym)=>new (class{constructor(env, sym, pos){this.type="literal";this.val=""+sym[1];this.pos=pos;}})(env, sym)/*62*/
,(env, sym)=>new (class{constructor(env, sym, pos){this.type="symbol";this.val=sym[1];this.pos=pos;}})(env, sym)/*63*/
