...
import { FIRST, isNonTerm, filloutGrammar, Item, EMPTY_PRODUCTION } from "../common2.mjs";
import { gotoCollisionCheck, reduceCollisionCheck, shiftCollisionCheck } from "./error2.mjs";
