...
I543_prd_production=function (sym,env,lex){env.host_lex = lex.copy();env.prod_name = sym[sym.length - 2].name;},
...
I545_prd_production=function (sym,env,lex){env.host_lex = lex.copy();env.prod_name = sym[sym.length - 3].name;},
