 ...
 * disclaimer notice.
 */
import { getRootSym, Sym_Is_A_Token } from '../../../../source/typescript/grammar/nodes/symbol.js';
import { fail_state_mask, goto_state_mask, normal_state_mask } from '../../../../source/typescript/runtime/kernel_next.js';
import {
    BlockData,
    BranchIRState,
...
} from '../../../../source/typescript/types/index.js';
import { numeric_sort } from '../../hc_ts_common/source/utilities/array_globals.js';
import { default_case_indicator, ir_reduce_numeric_len_id } from '../../../../source/typescript/utilities/magic_numbers.js';
