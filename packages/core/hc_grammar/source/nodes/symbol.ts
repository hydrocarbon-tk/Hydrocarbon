...
import {
    ...
    DefinedSymbol, EmptySymbol, EOFSymbol, GeneratedIdentifier, GeneratedNewLine, GeneratedNumber, GeneratedSpace, GeneratedSymbol, GrammarObject, HCG3Symbol, LookBehindSymbol,
    ProductionSymbol,
