...
import { compileHCGParser, compileGrammar, compileJSParserFromGrammar } from "../tools.js";
...
assert_group(sequence, 10000, () => {
    ...
    const mock_js_parser = await compileJSParserFromGrammar(mock_js_source, true);
