#! /home/anthony/.nvm/versions/node/v14.14.0/bin/node

import { traverse } from "../../../conflagrate-experimental/build/library/conflagrate.js";
import { parser, sk } from "../../build/library/skribble/skribble.js";
import { skribble_mappings } from "../../build/library/skribble/mappings.js";




// assert(parser("[mut] t:u32 = 0xFFF") == "");
const b = sk`fn test:u32(){
...
const d = sk`[mut] t:u32 = ${a};  [mut] t:u32 = 0b110;`;
console.log({ skribble_mappings });

for (const { node } of traverse(a, skribble_mappings)) {
    console.log({ node });
}